...
(function () {
    ...
    if (window.__CANVAS_DASHBOARD__) return;
    window.__CANVAS_DASHBOARD__ = true;
    ...
    const BUILTIN_TOOLS = [
        { id: "open-chatgpt",  name: "ChatGPT",  color: "#10a37f", description: "Open ChatGPT",             run: () => popup("https://chat.openai.com") },
        { id: "open-claude",   name: "Claude",   color: "#c96442", description: "Open Claude AI",           run: () => popup("https://claude.ai/new") },
        { id: "open-copilot",  name: "Copilot",  color: "#2563eb", description: "Open Microsoft Copilot",   run: () => popup("https://copilot.microsoft.com") },
        { id: "open-gemini",   name: "Gemini",   color: "#8b5cf6", description: "Open Google Gemini",       run: () => popup("https://gemini.google.com") }
    ];
    ...
    function buildBar() {
        ...
        tab.id = "cvd-tab";
        tab.innerHTML = `<span>Canvas Tools</span><span id="cvd-tab-arrow">▲</span>`;
        ...
        panel.appendChild(makeLabel("AI"));
        BUILTIN_TOOLS.forEach(t => panel.appendChild(makeButton(t)));

        panel.appendChild(makeDivider());
        panel.appendChild(makeLabel("Your Tools"));

        const empty = document.createElement("span");
        empty.id = "cvd-empty";
        empty.textContent = "Install a script to see it here";
    ...
    // All scripts and the exact GM storage keys each one uses
    ...
    function makeLabel(text) {
        ...
        el.className = "cvd-section-label";
        el.textContent = text;
        return el;
    }
